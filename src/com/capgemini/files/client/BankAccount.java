...
public class BankAccount implements Serializable {
	...
	{  
		...
		os.writeLong(debitCard.getCardNo());
		os.writeInt(debitCard.getCvv());
		os.writeInt(debitCard.getExpiryMonth());
		os.writeInt(debitCard.getExpiryYear());

	}
	private void readObject(ObjectInputStream is) throws ClassNotFoundException, IOException 
	{ 
		is.defaultReadObject();
			debitCard=new DebitCard(is.readLong(),is.readInt(),is.readInt(),is.readInt());
